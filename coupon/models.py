...
class Coupon(models.Model):
    ...
    discount_value = models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(100)])  # Percentage value, should be between 0 and 100
    min_purchase_amount = models.PositiveIntegerField(validators=[MinValueValidator(1)],help_text="Minimum cart amount required to apply this coupon",null=True)
    max_discount_amount = models.PositiveIntegerField(validators=[MinValueValidator(1)],help_text="Maximum discount amount allowed for this coupon",null=True)
